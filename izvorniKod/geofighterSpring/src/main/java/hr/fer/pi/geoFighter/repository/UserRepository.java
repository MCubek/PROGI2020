...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query(value = "select location_cards.lcd_id, location_cards.name, location_cards.difficulty, location_cards.population, location_cards.uncommonness, location_cards.photourl\n" +
