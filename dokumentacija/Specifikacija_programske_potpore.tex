	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_enum}
				...
				\begin{packed_enum}
					...
					\item se prijaviti u sustav koristeći e-mail i lozinku
			...
			\item pristupiti borbi slanjem ili prihvaćanjem zahtjeva
		...
		\item dobiti novu kartu ako ju je igrač prijavio te je ona odobrena
...
\item  \underbar{OSRM (sudionik) :}
		\begin{packed_enum}
			\item omogućava pronalazak puta obilaska svih lokacija (pomoću problema trgovačkog putnika)  za koje je zatražena potvrda s terena
		\end{packed_enum}
			\end{packed_enum}
			...
			\subsection{Obrasci uporabe}
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Pokušati se prijaviti ponovno
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Prikazuju se detalji drugog igrača: ime, rang, statistika zadnjih 10 borbi te sakupljene karte.
					\end{packed_enum}
				\end{packed_item}
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Igrači izabiru po 3 karte iz vlastite kolekcije.
						\item Borba se izvršava kroz matematički izračun s obzirom na jačine odabranih karata.
						\item Oba igrača dobivaju obavijest o ishodu borbe.
					\end{packed_enum}
					...
					\item[] \begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item  Prilikom pritiska na gumb "Traži borbu" igrač se ne može pridružiti borbi jer nema dovoljno karata za početak borbe (ili ih nema dovoljno ili su na cooldownu pa nisu trenutno dostupne). Sustav mu predlaže da pođe u istraživanje kako bi sakupio više karata i uvijek bio spreman na borbu.
							
						\end{packed_enum}
					\item[5.a] Atributi karti su jednaki
					\item[] \begin{packed_enum}
						
						\item  Ako su atributi karata jednaki rezultat borbe je neriješeno.
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Korisnik odabire 3 karte za borbu. 
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Aplikacija prikaže poruku koja sadrži informaciju o ishodu borbe.
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Korisnikova prijava je prihvaćena.
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Kartograf klikom na opciju za pregled prijava lokacija šalje upit bazi podataka.
						\item Prijavljene lokacije se kartografu prikažu na karti.
						\item Kartograf klikom na gumb za uređivanje otvara prozor s podatcima lokacije.
		...
		\end{figure}
			\subsection{Sekvencijski dijagrami}
				...
				\textnormal{Igrač šalje zahtjev za borbom ili privaća dobiveni zahtjev. Web aplikacija potom dohvaća suparnika. Igrači izabiru po 3 karte s kojima će sudjelovati u borbi. Borba se odvija matematičkim izračunom s obzirom na jačinu atributa odabranih karata. Proglašava se pobjednik i u bazu podataka se spremaju podaci te borbe.}\\
				\begin{figure}[H]
					\centering
			...
			\subsubsection{Obrazac uporabe UC12.1 - Uređivanje podataka lokacije}
