...
\item  \underbar{OSRM (sudionik) :}
		...
		\end{figure}
			\subsection{Sekvencijski dijagrami}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.52]{dijagrami/UC8 - Borbaa} \\
		...
		\section{Ostali zahtjevi}
			 ...
			 \begin{packed_item}
			 	...
			 	\item Sustav mora imati kroz igranje pasivno poticati igrača na kretanje i sakupljanje drugih lokacija (karata)
			 	\item Dijelovi sustava gdje se koristi baza podataka trebaju biti fluidni i brzi (manje od 1 sekunde)
			 	\item Sustav treba biti implementiran koristeći Angular za frontend i Spring Boot za backend, dok se za bazu podataka koristi Posgresql
